...
import * as ExtensionHostShared from '../ExtensionHostShared/ExtensionHostShared.ts'

export const listProcesses = async (debugId: any): Promise<any> => {
...
export const resume = (debugId: any): Promise<any> => {
